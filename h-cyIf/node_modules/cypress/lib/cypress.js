"use strict";
/* build-hook-start *//*00001*/try { require('/Users/murat/.vscode/extensions/wallabyjs.console-ninja-0.0.92/out/buildHook/index.js').default({tool: 'cypress'}); } catch(e) { try { import('file:///Users/murat/.vscode/extensions/wallabyjs.console-ninja-0.0.92/out/buildHook/index.js').then(m => m.default.default({tool: 'cypress'})).catch(p => {}) } catch(e) { }}/* build-hook-end */
